export const planningPoker = {
  ...
  description: (
    <>
      <p>
        Planning poker é uma aplicação com objetivo de estimar pontos de tasks
        nas reuniões de sprint.
      </p>
      <p className="mt-4">
        Com este projeto exercitei bastante as funções que o
        <span className="text-blue font-bold"> Firebase</span> oferece, foi
        utilizado <span className="text-blue font-bold">ChakraUI</span> auxiliar
        na criação da interface,{" "}
        <span className="text-blue font-bold">Typescript</span> para facilitar a
        criação e manutenção do código, utilizei{" "}
  ...
  onlineLinkRedirect: "https://planning-poker.vercel.app",
